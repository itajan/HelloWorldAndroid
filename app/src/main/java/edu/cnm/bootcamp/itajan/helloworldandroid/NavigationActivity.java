...
import edu.cnm.bootcamp.itajan.helloworldandroid.fragments.ImgurFragment;
import edu.cnm.bootcamp.itajan.helloworldandroid.fragments.MainFragment;
import edu.cnm.bootcamp.itajan.helloworldandroid.fragments.SettingsFragment;
...
public class NavigationActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_hello) {
            ...
            FragmentTransaction fragmentTransaction
                = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.fragment_container, ImgurFragment.newInstance("", "")
            );
            fragmentTransaction.commit();
        }
